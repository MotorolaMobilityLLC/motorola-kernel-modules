...
def get_kernel_headers():
    ...
    if native.existing_rule("//kernel_device_modules-6.12:mtk_public_headers"):
        headers.append("//kernel_device_modules-6.12:mtk_public_headers")
    elif native.existing_rule("//kernel_device_modules-6.6:mtk_public_headers"):
