...
ifneq ($(FOCALTECH_TOUCH_IC_NAME),)
	...
	KERNEL_CFLAGS += CONFIG_FOCALTECH_TOUCH_IC_NAME=$(FOCALTECH_TOUCH_IC_NAME)
else
...
ifneq ($(FTS_SUPPORT_HIRES_X),)
	KERNEL_CFLAGS += CONFIG_SUPPORT_FTS_HIRES_X=$(FTS_SUPPORT_HIRES_X)
else
ifeq ($(FTS_SUPPORT_HIGH_RESOLUTION),true)
...
else ifeq ($(CONFIG_INPUT_TOUCHSCREEN_MMI),true)
    KERNEL_CFLAGS += CONFIG_INPUT_TOUCHSCREEN_MMI=y
endif
...
ifeq ($(ENABLE_GTP_PALM_CANCEL),true)
	KERNEL_CFLAGS += CONFIG_ENABLE_FTS_PALM_CANCEL=y
endif
