...
#include "cypsoc_picoleaf.h" // ADDED for Picoleaf
...
#define PT_WATCHDOG_RESTART_TIMEOUT            50000
...
#define PT_PIP_CMD_DEFAULT_TIMEOUT              5000
...
/* Max counts */
#define PT_WATCHDOG_RETRY_COUNT                    4
#define PT_WATCHDOG_HWRESET_RETRY_COUNT            2
...
#define PT_RAM_ID_ACT_DIST_ALWAYS_REPORT		0x34
#define PT_RAM_ID_TOUCHMODE_ENABLED_SIZE		1
#define PT_RAM_ID_PROXIMITY_ENABLE_SIZE			1
#define PT_RAM_ID_ACT_DIST_ALWAYS_REPORT_SIZE	1
...
struct pt_mt_data {
	...
	struct cypsoc_picoleaf_data *cypsoc_picoleaf_data;
#endif
};
...
#ifdef CONFIG_DRM
int pt_drm_panel_check(struct device_node *dt);
#endif
