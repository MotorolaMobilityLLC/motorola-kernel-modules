...
ifneq ($(FOCALTECH_MULTI_FT8057X),)
	KERNEL_CFLAGS += CONFIG_INPUT_FOCALTECH_MULTI_FT8057X=y
endif
...
ifeq ($(FOCALTECH_CHECK_DEVICE_BOOTMODE_SUPPORT),true)
        KERNEL_CFLAGS += CONFIG_FTS_CHECK_DEVICE_BOOTMODE_SUPPORT=y
endif
...
LOCAL_MODULE := focaltech_0flash_mmi_v3_u.ko
