...
#endif
#define DRIVER_VERSION			"3.0.12.0.250715"
...
#if ENABLE_CASCADE
#define	CASCADE_NUM					2
#else
#define	CASCADE_NUM					0
#endif
...
#define DATA_FORMAT_DEBUG_LITE_ALS_CMD					0x07
/* Pen data format */
...
#define P5_X_SET_DDI_STATUS					0xD1
#define P5_X_GET_DDI_STATUS					0xD2
...
extern int ili_fw_dump_iram_data(u32 start, u32 end, bool save, bool mcu, bool reset);
extern int ili_fw_dump_flash_data(u32 start, u32 end, bool user, bool mcu, bool reset);
...
extern int ili_ic_get_ddi_reg_by_fw(u8 page, u8 reg, u8 *data);
extern int ili_ic_set_ddi_reg_by_fw(u8 page, u8 reg, u8 val);
...
extern int ili_cascade_ic_get_info(bool enter_ice, bool exit_ice, bool mcu, bool reset);
...
extern void ili_wdt_reset_status( bool enter_ice, bool exit_ice, bool mcu);
extern int ili_cascade_reset_ctrl(int reset_mode, bool enter_ice);
extern int ili_cascade_rw_tp_reg(u32 mcu, u32 type, u32 addr, u32 wdata, u32 wlen, u32 *rdata, bool bypass_exit_ice);
extern int ili_cascade_rw_tp_reg_v2(u32 mcu, u32 type, u32 addr, u32 wdata, u32 wlen, u32 *rdata);
...
extern u8 ili_calc_packet_checksum(const u8 *packet, int len);
...
extern int ili_ice_both_write_register(u32 addr, u32 data, int len);
extern int ili_ice_master_write_register(u32 addr, u32 data, int len);
