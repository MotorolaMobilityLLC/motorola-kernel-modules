...
ifeq ($(CONFIG_CTS_MULTI_TP_MODULE_EN),true)
	KERNEL_CFLAGS += CTS_MULTI_TP_MODULE_EN=y
	KBUILD_OPTIONS += CTS_MULTI_TP_MODULE_EN=y
endif
...
ifeq ($(CONFIG_CHIPONE_HARDWARE_STATUS),true)
        KERNEL_CFLAGS += CONFIG_TOUCH_HARDWARE_STATUS=y
...
LOCAL_MODULE := chipone_tddi_v3_mmi.ko
