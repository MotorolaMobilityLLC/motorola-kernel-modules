...
static const struct cts_firmware *cts_request_newer_driver_builtin_firmware(u32
        hwid, u16 fwid, u16 device_fw_ver)
{
...
const struct cts_firmware *cts_request_newer_firmware_from_fs(const struct
        cts_device *cts_dev, const char *filepath, u16 curr_version)
{
...
const struct cts_firmware *cts_request_firmware(const struct cts_device
        *cts_dev, u32 hwid, u16 fwid, u16 curr_firmware_ver)
{
...
#ifdef CFG_CTS_DRIVER_BUILTIN_FIRMWARE
    firmware_builtin =
        cts_request_newer_driver_builtin_firmware(hwid, fwid, curr_firmware_ver);
#endif /* CFG_CTS_DRIVER_BUILTIN_FIRMWARE */
