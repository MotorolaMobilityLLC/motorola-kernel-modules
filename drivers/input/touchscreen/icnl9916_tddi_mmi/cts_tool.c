        ...
        unsigned long arg)
{
    ...
    case CTS_TOOL_IOCTL_TEST_RAWDATA:{
        ...
        (struct cts_test_rawdata_ioctl_data __user *)arg,
        sizeof(param)))
            return -EFAULT;
    ...
    case CTS_TOOL_IOCTL_TEST_NOISE:{
        ...
        if (copy_from_user(&param,
        (struct cts_test_noise_ioctl_data__user *)arg,
        sizeof(param)))
            return -EFAULT;
    ...
    case CTS_TOOL_IOCTL_TEST_OPEN:{
        ...
        if (copy_from_user(&param,
        (struct cts_test_open_ioctl_data __user *)arg,
        sizeof(param)))
            return -EFAULT;
    ...
    case CTS_TOOL_IOCTL_TEST_SHORT:{
        ...
        if (copy_from_user(&param, (struct cts_test_short_ioctl_data
    ...
    case CTS_TOOL_IOCTL_TEST_COMP_CAP:{
        ...
        if (copy_from_user(&param, (struct cts_test_comp_cap_ioctl_data
        __user *)arg, sizeof(param)))
                return -EFAULT;

        return cts_compensate_cap_test(cts_dev, param.min, param.max);
    }
