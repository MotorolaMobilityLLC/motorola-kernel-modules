...
#endif //USE_SYS_SUSPEND_METHOD
#endif // CONFIG_DRM
#endif // CONFIG_OVT_EARLY_SUSPEND
...
static int ovt_tcm_probe(struct platform_device *pdev)
{
	...
	sysfs_dir = kobject_create_and_add(OVT_DRIVER_NAME,
...
static void ovt_tcm_remove(struct platform_device *pdev)
{
	int idx;
	struct ovt_tcm_module_handler *mod_handler;
	struct ovt_tcm_module_handler *tmp_handler;
