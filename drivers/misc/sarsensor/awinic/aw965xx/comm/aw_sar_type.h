...
typedef int32_t (*aw_sar_chip_effuse_status_check_t)(void *data);
...
enum sar_coderam_compelete_status {
	AW_SAR_CODERAM_UPLOADING = 0,
	AW_SAR_CODERAM_COMPELETE = 1,
};
...
struct aw_sar_chip_config {
	...
	/*If requested by resources, please release*/
	aw_sar_chip_effuse_status_check_t p_effuse_check;
...
struct aw_sar {
	...
	uint8_t driver_update_coderam_reg;
	/*handler_anomalies*/
