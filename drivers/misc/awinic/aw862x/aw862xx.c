...
static void aw862xx_cont_config(struct aw_haptic *aw_haptic)
{
	...
	haptic_nv_i2c_write_bits(aw_haptic, AW862XX_REG_CONTCFG6,
				 ...
				 (AW862XX_BIT_CONTCFG6_TRACK_DISABLE |
...
static void aw862xx_misc_para_init(struct aw_haptic *aw_haptic)
{
	...
	aw_haptic->info.cont_drv2_lvl = AW862XX_DRV2_LVL_FORMULA(aw_haptic->info.lra_vrms);
				   ...
				   uint8_t addr, uint8_t val)
{
	...
	case AW_PROTECT_CFG_3:
		haptic_nv_i2c_writes(aw_haptic, AW862XX_REG_PWMCFG4, &val,
				     AW_I2C_BYTE_ONE);
		break;
	default:
		break;
...
static uint8_t aw862xx_get_prctmode(struct aw_haptic *aw_haptic)
{
	...
	haptic_nv_i2c_reads(aw_haptic, AW862XX_REG_DETCFG1, &reg_val,
			    AW_I2C_BYTE_ONE);
	reg_val &= 0x08;
	return reg_val;
}
...
static uint8_t aw862xx_judge_rtp_going(struct aw_haptic *aw_haptic)
{
	...
	haptic_nv_i2c_reads(aw_haptic, AW862XX_REG_PLAYCFG3, &mode,
			    AW_I2C_BYTE_ONE);
	haptic_nv_i2c_reads(aw_haptic, AW862XX_REG_GLBRD5, &glb_st,
			    AW_I2C_BYTE_ONE);
