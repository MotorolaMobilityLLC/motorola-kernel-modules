...
ifeq ($(USE_MMI_GLINK_CHARGER), true)
		KERNEL_CFLAGS += CONFIG_USE_MMI_GLINK_CHARGER=y
		KBUILD_OPTIONS += CONFIG_USE_MMI_GLINK_CHARGER=y
		LOCAL_ADDITIONAL_DEPENDENCIES := $(KERNEL_MODULES_OUT)/mmi_glink_charger.ko
endif
