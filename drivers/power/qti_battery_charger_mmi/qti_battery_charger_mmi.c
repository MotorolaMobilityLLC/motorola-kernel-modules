...
static enum power_supply_property battery_props[] = {
	...
	POWER_SUPPLY_PROP_QCOM_BATTERY_CHARGE_CONTROL_EN, /* charge control limit enable */
	POWER_SUPPLY_PROP_CHARGE_CONTROL_START_THRESHOLD, /* recharge threshold */
	POWER_SUPPLY_PROP_CHARGE_CONTROL_END_THRESHOLD, /* charge threshold */
	POWER_SUPPLY_PROP_CURRENT_AVG, /**< ibatt in uA, negative is discharging >*/
	POWER_SUPPLY_PROP_BATTERY_CELL_COUNT, /* parallel battery pack count, MSB[15:8]: available parallel pack count LSB[7:0]: expected total parallel pack count*/
	POWER_SUPPLY_PROP_QNS_FV_MAX,
	POWER_SUPPLY_PROP_QNS_FCC_MAX,
};
