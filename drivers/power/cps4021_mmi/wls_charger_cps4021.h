...
#ifndef __WLS_CHARGER_CPS4021__
#define __WLS_CHARGER_CPS4021__
 ...
 *  CMD REG
 ****************************************************************************/
#define CPS_PROGRAM_BUFFER_SIZE   32         /*64 128 256 512*/
...
#define RX_INT_FSK_ACK           (0x01<<2)
#define RX_INT_FSK_TIMEOUT            (0x01<<3)
#define RX_INT_FSK_PKT         (0x01<<4)
#define RX_INT_VRECT_OVP         (0x01<<5)
#define RX_INT_VRECT_BV         (0x01<<6)
#define RX_INT_OTP              (0x01<<7)
#define RX_INT_MLDO_OCP              (0x01<<8)
#define RX_INT_MLDO_SCP              (0x01<<9)
#define RX_INT_MLDO_OPP             (0x01<<10)
#define RX_INT_DEBUG_INFO              (0x01<<11)
#define RX_INT_RX_MODE_CHG         (0x01<<12)
#define RX_INT_NEGO_DONE              (0x01<<13)
//#define RX_INT_START_OV             (0x01<<14) //bit14 yuliu
#define RX_INT_START_OV              (0x01<<19)

#define RX_INT_HS_OK     (0x01<<28)
#define RX_INT_HS_FAIL     (0x01<<29)
#define RX_INT_FC_OK     (0x01<<30)
#define RX_INT_FC_FAIL     (0x01<<31)

#define RX_INFO_FLAG_MLDO_OFF           (0x1 << 0)
#define RX_INFO_FLAG_MLDO_ON            (0x1 << 1)
#define RX_INFO_FLAG_HEAVY_LOAD         (0x1 << 2)
#define RX_INFO_FLAG_LIGHT_LOAD         (0x1 << 3)
#define RX_INFO_FLAG_VRECT_OVP_TO       (0x1 << 4)
#define RX_INFO_FLAG_MLDO_HOCP            (0x1 << 5)
#define RX_INFO_FLAG_AC_LOSS            (0x1 << 6)
#define RX_INFO_FLAG_SR_BRI_SW_FAIL     (0x1 << 7)
#define RX_INFO_FLAG_SR_BRI_SW_SUCC     (0x1 << 8)
