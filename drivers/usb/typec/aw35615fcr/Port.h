...
#define SNK_PDO_VOL_SIZE   7
#define SNK_PDO_CUR_SIZE   7
#define SNK_PPS_VOL_SIZE   12
#define SNK_PPS_CUR_SIZE   6
#define SRC_PDO_VOL_SIZE   7
#define SRC_PDO_CUR_SIZE   7
#define SRC_PPS_VOL_SIZE   12
#define SRC_PPS_CUR_SIZE   6
...
struct Port {
	...
	AW_U32                 snk_pdo_vol[SNK_PDO_VOL_SIZE];
	AW_U32                 snk_pdo_cur[SNK_PDO_CUR_SIZE];
	AW_U32                 snk_pps_vol[SNK_PPS_VOL_SIZE];
	AW_U32                 snk_pps_cur[SNK_PPS_CUR_SIZE];
	AW_U32                 src_pdo_vol[SRC_PDO_VOL_SIZE];
	AW_U32                 src_pdo_cur[SRC_PDO_CUR_SIZE];
	AW_U32                 src_pps_vol[SRC_PPS_VOL_SIZE];
	AW_U32                 src_pps_cur[SRC_PPS_CUR_SIZE];
	AW_U16                 snk_pdo_size;
	AW_U16                 snk_pps_size;
	AW_U16                 src_pdo_size;
	AW_U16                 src_pps_size;
	AW_U16                 toggle_check_num;
	AW_U16                 try_wait_vbus;
