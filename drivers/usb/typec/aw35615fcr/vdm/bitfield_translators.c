...
UnstructuredVdmHeader getUnstructuredVdmHeader(AW_U32 in)
{
	...
	ret.svid = (vdm_svid)((in >> 16) & 0x0000FFFF);
	ret.vdm_type = (VdmType)((in >> 15) & 0x00000001);
...
StructuredVdmHeader getStructuredVdmHeader(AW_U32 in)
{
	...
	ret.svid = (vdm_svid)((in >> 16) & 0x0000FFFF);
	ret.vdm_type = (VdmType)((in >> 15) & 0x00000001);
	ret.svdm_version = (SvdmVersion)((in >> 13) & 0x00000003);
	ret.obj_pos = (ObjPos)((in >> 8) & 0x00000007);
	ret.cmd_type = (CmdType)((in >> 6) & 0x00000003);
	ret.command = (dis_command)((in >> 0) & 0x0000001F);
...
IdHeader getIdHeader(AW_U32 in)
{
	...
	ret.product_type_ufp = (ProductType)((in >> 27) & 0x00000007);
	ret.product_type_dfp = (ProductType)((in >> 23) & 0x7U);
...
CableVdo getCableVdo(AW_U32 in)
{
	...
	ret.cable_to_type = (CableToType)((in >> 18) & 0x00000003);
	ret.cable_to_pr = (CableToPr)((in >> 17) & 0x00000001);
	ret.cable_latency = (CableLatency)((in >> 13) & 0x0000000F);
	ret.cable_term = (CableTermType)((in >> 11) & 0x00000003);
	ret.sstx1_dir_supp = (SsDirectionality)((in >> 10) & 0x00000001);
	ret.sstx2_dir_supp = (SsDirectionality)((in >> 9) & 0x00000001);
	ret.ssrx1_dir_supp = (SsDirectionality)((in >> 8) & 0x00000001);
	ret.ssrx2_dir_supp = (SsDirectionality)((in >> 7) & 0x00000001);
	ret.vbus_current_handling_cap = (VbusCurrentHandlingCapability)((in >> 5) & 0x00000003);
	ret.vbus_thru_cable = (VbusThruCable)((in >> 4) & 0x00000001);
	ret.sop2_presence = (Sop2Presence)((in >> 3) & 0x00000001);
	ret.usb_ss_supp = (UsbSsSupport)((in >> 0) & 0x00000007);
...
AmaVdo getAmaVdo(AW_U32 in)
{
	...
	ret.vconn_full_power = (VConnFullPower)((in >> 5) & 0x00000007);
	ret.vconn_requirement = (VConnRequirement)((in >> 4) & 0x00000001);
	ret.vbus_requirement = (VBusRequirement)((in >> 3) & 0x00000001);
	ret.usb_ss_supp = (AmaUsbSsSupport)((in >> 0) & 0x00000007);
