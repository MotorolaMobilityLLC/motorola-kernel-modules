...
ifeq ($(TARGET_MOTO_ENABLE_MDPF), true)
	KBUILD_OPTIONS += CONFIG_MOTO_ENABLE_MDPF=y
	KERNEL_CFLAGS += CONFIG_MOTO_ENABLE_MDPF=y
endif

ifeq ($(MOTO_LOCKING_2), true)
	KBUILD_OPTIONS += CONFIG_MOTO_LOCKING_2=y
	KERNEL_CFLAGS += CONFIG_MOTO_LOCKING_2=y
endif

ifeq ($(MOTO_BOOST_RT_KWORKER_HIGHEST), true)
	KBUILD_OPTIONS += CONFIG_MOTO_BOOST_RT_KWORKER_HIGHEST=y
	KERNEL_CFLAGS += CONFIG_MOTO_BOOST_RT_KWORKER_HIGHEST=y
endif
